document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Optional: show success state if form uses AJAX (data-ajax attribute)
      if (contactForm.dataset.ajax !== undefined) {
        ...
        fetch(action, {
          ...
          .catch(function () {
            const errorMsg = contactForm.querySelector('.submit-error');
            if (errorMsg) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Libero Bike משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '302208aa-d8f6-4d0c-b6be-5841ccc1d57f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '302208aa-d8f6-4d0c-b6be-5841ccc1d57f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '302208aa-d8f6-4d0c-b6be-5841ccc1d57f';
